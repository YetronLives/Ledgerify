...
function EditAccountForm({ account, onUpdate, onCancel, error }) {
    const [creationDate, setCreationDate] = useState(() => {
        // If account has a date (e.g., from addedDate), parse it; otherwise use today
    ...
    const handleSubmit = (e) => {
        ...
        // updatedAccountData.creationDate = creationDate;
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="space-y-3 max-h-[70vh] overflow-y-auto pr-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="number" type="text" defaultValue={account.number} disabled className="w-full px-3 py-2 border rounded-lg bg-gray-100"/>
                </div>
            </div>
            <div>
